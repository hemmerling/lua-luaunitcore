...
local function check_tap_output(fileToRun, options, output, refOutput, refExitCode, envOptions, outputArg)
    ...
    osExpectedCodeExec(refExitCode, "%s %s %s %s %s > %s", envOptions, LUA, fileToRun, outputArg, options, output)
...
local function check_text_output(fileToRun, options, output, refOutput, refExitCode)
    -- remove output
    osExpectedCodeExec(refExitCode, "%s %s --output text %s > %s", LUA, fileToRun, options, output)
...
local function check_nil_output(fileToRun, options, output, refOutput, refExitCode)
    -- remove output
    osExpectedCodeExec(refExitCode, "%s %s --output nil %s > %s", LUA, fileToRun, options, output)
...
local function check_xml_output(
    fileToRun,
    options,
    output,
    xmlOutput,
...
function testTapDefault()
    ...
    lu.assertEquals(
        ...
        check_tap_output(
            ...
            "test/ref/errFailPassTapDefault.txt",
            10
        )
    )
    lu.assertEquals(
        ...
        check_tap_output(
            ...
            "test/ref/errFailPassTapDefault-success.txt",
            0
        )
    )
    lu.assertEquals(
        ...
        check_tap_output(
            ...
            "test/ref/errFailPassTapDefault-failures.txt",
            5
        )
    )
    if IS_UNIX then
...
function testTapVerbose()
    ...
    lu.assertEquals(
        ...
        check_tap_output(
            ...
            "test/ref/errFailPassTapVerbose.txt",
            10
        )
    )
    lu.assertEquals(
        ...
        check_tap_output(
            ...
            "test/ref/errFailPassTapVerbose-success.txt",
            0
        )
    )
    lu.assertEquals(
        ...
        check_tap_output(
            "test/test_with_err_fail_pass.lua",
            "--verbose -p Succ -p Fail",
            "test/errFailPassTapVerbose-failures.txt",
            "test/ref/errFailPassTapVerbose-failures.txt",
            5
        )
    )
end
...
function testTapQuiet()
    ...
    lu.assertEquals(
        ...
        check_tap_output(
            ...
            "test/ref/errFailPassTapQuiet.txt",
            10
        )
    )
    lu.assertEquals(
        ...
        check_tap_output(
            ...
            "test/ref/errFailPassTapQuiet-success.txt",
            0
        )
    )
    lu.assertEquals(
        ...
        check_tap_output(
            ...
            "test/ref/errFailPassTapQuiet-failures.txt",
            5
        )
    )
end
...
function testTextDefault()
    ...
    lu.assertEquals(
        ...
        check_text_output(
            ...
            "test/ref/errFailPassTextDefault.txt",
            10
        )
    )
    lu.assertEquals(
        ...
        check_text_output(
            ...
            "test/ref/errFailPassTextDefault-success.txt",
            0
        )
    )
    lu.assertEquals(
        ...
        check_text_output(
            ...
            "test/ref/errFailPassTextDefault-failures.txt",
            5
        )
    )
end
...
function testTextVerbose()
    ...
    lu.assertEquals(
        ...
        check_text_output(
            ...
            "test/ref/errFailPassTextVerbose.txt",
            10
        )
    )
    lu.assertEquals(
        ...
        check_text_output(
            ...
            "test/ref/errFailPassTextVerbose-success.txt",
            0
        )
    )
    lu.assertEquals(
        ...
        check_text_output(
            ...
            "test/ref/errFailPassTextVerbose-failures.txt",
            5
        )
    )
end
...
function testTextQuiet()
    ...
    lu.assertEquals(
        ...
        check_text_output(
            ...
            "test/ref/errFailPassTextQuiet.txt",
            10
        )
    )
    lu.assertEquals(
        ...
        check_text_output(
            ...
            "test/ref/errFailPassTextQuiet-success.txt",
            0
        )
    )
    lu.assertEquals(
        ...
        check_text_output(
            ...
            "test/ref/errFailPassTextQuiet-failures.txt",
            5
        )
    )
end
...
function testNilDefault()
    lu.assertEquals(
        ...
        check_nil_output(
            "example_with_luaunit.lua",
            "",
            "test/exampleNilDefault.txt",
            "test/ref/exampleNilDefault.txt",
            12
        )
    )
    lu.assertEquals(
        ...
        check_nil_output(
            ...
            "test/ref/errFailPassNilDefault.txt",
            10
        )
    )
    lu.assertEquals(
        ...
        check_nil_output(
            ...
            "test/ref/errFailPassNilDefault-success.txt",
            0
        )
    )
    lu.assertEquals(
        ...
        check_nil_output(
            ...
            "test/ref/errFailPassNilDefault-failures.txt",
            5
        )
    )
end
...
function testXmlDefault()
    lu.assertEquals(
        ...
        check_xml_output(
            "example_with_luaunit.lua",
            "",
            "test/exampleXmlDefault.txt",
            "test/exampleXmlDefault.xml",
            "test/exampleXmllintDefault.xml",
            "test/ref/exampleXmlDefault.txt",
            "test/ref/exampleXmlDefault.xml",
            12
        )
    )
    lu.assertEquals(
        ...
        check_xml_output(
            "test/test_with_err_fail_pass.lua",
            "",
            "test/errFailPassXmlDefault.txt",
            "test/errFailPassXmlDefault.xml",
            "test/errFailPassXmllintDefault.xml",
            "test/ref/errFailPassXmlDefault.txt",
            "test/ref/errFailPassXmlDefault.xml",
            10
        )
    )
    lu.assertEquals(
        ...
        check_xml_output(
            "test/test_with_err_fail_pass.lua",
            "-p Succ",
            "test/errFailPassXmlDefault-success.txt",
            "test/errFailPassXmlDefault-success.xml",
            "test/errFailPassXmllintDefault.xml",
            "test/ref/errFailPassXmlDefault-success.txt",
            "test/ref/errFailPassXmlDefault-success.xml",
            0
        )
    )
    lu.assertEquals(
        ...
        check_xml_output(
            "test/test_with_err_fail_pass.lua",
            "-p Succ -p Fail",
            "test/errFailPassXmlDefault-failures.txt",
            "test/errFailPassXmlDefault-failures.xml",
            "test/errFailPassXmllintDefault.xml",
            "test/ref/errFailPassXmlDefault-failures.txt",
            "test/ref/errFailPassXmlDefault-failures.xml",
            5
        )
    )
...
function testXmlVerbose()
    lu.assertEquals(
        ...
        check_xml_output(
            "example_with_luaunit.lua",
            "--verbose",
            "test/exampleXmlVerbose.txt",
            "test/exampleXmlVerbose.xml",
            "test/exampleXmllintVerbose.xml",
            "test/ref/exampleXmlVerbose.txt",
            "test/ref/exampleXmlVerbose.xml",
            12
        )
    )
    lu.assertEquals(
        ...
        check_xml_output(
            "test/test_with_err_fail_pass.lua",
            "--verbose ",
            "test/errFailPassXmlVerbose.txt",
            "test/errFailPassXmlVerbose.xml",
            "test/errFailPassXmllintVerbose.xml",
            "test/ref/errFailPassXmlVerbose.txt",
            "test/ref/errFailPassXmlVerbose.xml",
            10
        )
    )
    lu.assertEquals(
        ...
        check_xml_output(
            "test/test_with_err_fail_pass.lua",
            "--verbose -p Succ",
            "test/errFailPassXmlVerbose-success.txt",
            "test/errFailPassXmlVerbose-success.xml",
            "test/errFailPassXmllintVerbose.xml",
            "test/ref/errFailPassXmlVerbose-success.txt",
            "test/ref/errFailPassXmlVerbose-success.xml",
            0
        )
    )
    lu.assertEquals(
        ...
        check_xml_output(
            "test/test_with_err_fail_pass.lua",
            "--verbose -p Succ -p Fail",
            "test/errFailPassXmlVerbose-failures.txt",
            "test/errFailPassXmlVerbose-failures.xml",
            "test/errFailPassXmllintVerbose.xml",
            "test/ref/errFailPassXmlVerbose-failures.txt",
            "test/ref/errFailPassXmlVerbose-failures.xml",
            5
        )
    )
end
...
function testXmlQuiet()
    lu.assertEquals(
        ...
        check_xml_output(
            "example_with_luaunit.lua",
            "--quiet",
            "test/exampleXmlQuiet.txt",
            "test/exampleXmlQuiet.xml",
            "test/exampleXmllintQuiet.xml",
            "test/ref/exampleXmlQuiet.txt",
            "test/ref/exampleXmlQuiet.xml",
            12
        )
    )
    lu.assertEquals(
        ...
        check_xml_output(
            "test/test_with_err_fail_pass.lua",
            "--quiet ",
            "test/errFailPassXmlQuiet.txt",
            "test/errFailPassXmlQuiet.xml",
            "test/errFailPassXmllintQuiet.xml",
            "test/ref/errFailPassXmlQuiet.txt",
            "test/ref/errFailPassXmlQuiet.xml",
            10
        )
    )
    lu.assertEquals(
        ...
        check_xml_output(
            "test/test_with_err_fail_pass.lua",
            "--quiet -p Succ",
            "test/errFailPassXmlQuiet-success.txt",
            "test/errFailPassXmlQuiet-success.xml",
            "test/errFailPassXmllintQuiet.xml",
            "test/ref/errFailPassXmlQuiet-success.txt",
            "test/ref/errFailPassXmlQuiet-success.xml",
            0
        )
    )
    lu.assertEquals(
        ...
        check_xml_output(
            "test/test_with_err_fail_pass.lua",
            "--quiet -p Succ -p Fail",
            "test/errFailPassXmlQuiet-failures.txt",
            "test/errFailPassXmlQuiet-failures.xml",
            "test/errFailPassXmllintQuiet.xml",
            "test/ref/errFailPassXmlQuiet-failures.txt",
            "test/ref/errFailPassXmlQuiet-failures.xml",
            5
        )
    )
end
...
function testTestWithXmlDefault()
    lu.assertEquals(
        ...
        check_xml_output(
            ...
            "",
            "test/testWithXmlDefault.txt",
            "test/testWithXmlDefault.xml",
            "test/testWithXmlLintDefault.txt",
            "test/ref/testWithXmlDefault.txt",
            "test/ref/testWithXmlDefault.xml",
            2
        )
    )
end
...
function testTestWithXmlVerbose()
    lu.assertEquals(
        ...
        check_xml_output(
            "test/test_with_xml.lua",
            "--verbose",
            "test/testWithXmlVerbose.txt",
            "test/testWithXmlVerbose.xml",
            "test/testWithXmlLintVerbose.txt",
            "test/ref/testWithXmlVerbose.txt",
            "test/ref/testWithXmlVerbose.xml",
            2
        )
    )
end
...
function testTestWithXmlQuiet()
    lu.assertEquals(
        ...
        check_xml_output(
            "test/test_with_xml.lua",
            "--quiet",
            "test/testWithXmlQuiet.txt",
            "test/testWithXmlQuiet.xml",
            "test/testWithXmlLintQuiet.txt",
            "test/ref/testWithXmlQuiet.txt",
            "test/ref/testWithXmlQuiet.xml",
            2
        )
    )
end
...
local filesToGenerateExampleXml = {
    {
        "example_with_luaunit.lua",
        "",
        "--output junit --name test/ref/exampleXmlDefault.xml",
        "test/ref/exampleXmlDefault.txt"
    },
    {
        "example_with_luaunit.lua",
        "--quiet",
        "--output junit --name test/ref/exampleXmlQuiet.xml",
        "test/ref/exampleXmlQuiet.txt"
    },
    {
        "example_with_luaunit.lua",
        "--verbose",
        "--output junit --name test/ref/exampleXmlVerbose.xml",
        "test/ref/exampleXmlVerbose.txt"
    }
}
...
local filesToGenerateErrFailPassXml = {
    ...
    },
    {
        "test/test_with_err_fail_pass.lua",
        "",
        "--quiet --output junit --name test/ref/errFailPassXmlQuiet.xml",
        "test/ref/errFailPassXmlQuiet.txt"
    },
    {
        "test/test_with_err_fail_pass.lua",
    ...
    },
    {
        "test/test_with_err_fail_pass.lua",
        "",
        "--verbose --output junit --name test/ref/errFailPassXmlVerbose.xml",
        "test/ref/errFailPassXmlVerbose.txt"
    },
    {
        "test/test_with_err_fail_pass.lua",
...
local filesToGenerateTestXml = {
    {
        "test/test_with_xml.lua",
        "",
        "--output junit --name test/ref/testWithXmlDefault.xml",
        "test/ref/testWithXmlDefault.txt"
    },
    {
        "test/test_with_xml.lua",
        "--verbose",
        "--output junit --name test/ref/testWithXmlVerbose.xml",
        "test/ref/testWithXmlVerbose.txt"
    },
    {
        "test/test_with_xml.lua",
        "--quiet",
        "--output junit --name test/ref/testWithXmlQuiet.xml",
        "test/ref/testWithXmlQuiet.txt"
    }
}
...
local filesToGenerateStopOnError = {
    {
        "test/test_with_err_fail_pass.lua",
        "",
        "--output text --quiet -p Succ --error --failure",
        "test/ref/errFailPassTextStopOnError-1.txt"
    },
    {
        "test/test_with_err_fail_pass.lua",
        "",
        "--output text --quiet -p TestSome --error",
        "test/ref/errFailPassTextStopOnError-2.txt"
    },
    {
        "test/test_with_err_fail_pass.lua",
        "",
        "--output text --quiet -p TestAnoth --failure",
        "test/ref/errFailPassTextStopOnError-3.txt"
    },
    {
        "test/test_with_err_fail_pass.lua",
        "",
        "--output text --quiet -p TestSome --failure",
        "test/ref/errFailPassTextStopOnError-4.txt"
    }
}
...
local filesSetIndex = {
    ...
    ErrFail = table_join(filesToGenerateErrFailPassText, filesToGenerateErrFailPassTap, filesToGenerateErrFailPassXml),
